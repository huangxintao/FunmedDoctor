...
public class APIServiceImplInfo {
    /**
     * retrofit客户端
     */
    ...
    private APIServiceImplInfo() {
        sRetrofit = new Retrofit.Builder()
                .baseUrl(ApiService.BASE_URL_INFORMATION)
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create())
                .addConverterFactory(GsonConverterFactory.create())
                .build();
    }

    public static APIServiceImplInfo getInstance() {
        return APIServiceImplInfo.APIServiceHolder.INSTANCE;
    }
...
//                                .addHeader("Accept-Encoding", "gzip, deflate")
    ...
    private static class APIServiceHolder {
         ...
         * 单例类辅助内部类实例
         */
        private static final APIServiceImplInfo INSTANCE = new APIServiceImplInfo();
    }
}
